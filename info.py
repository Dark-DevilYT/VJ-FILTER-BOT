...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5899803696').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://titu:titu@titu.y4ldsbr.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "titu")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Bots')

# Others
VERIFY = bool(environ.get('VERIFY', False))
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'onepagelink.in')
SHORTLINK_API = environ.get('SHORTLINK_API', '9667726b259e879d248cc2ca793708c9d435fa47')
IS_SHORTLINK = bool(environ.get('IS_SHORTLINK', True))
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]
MAX_B_TN = environ.get("MAX_B_TN", "5")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
PORT = environ.get("PORT", "8080")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/t2zonerequest')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/t2zone')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/How_To_Open_Linkl')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'Hello My Dear Friends ❤️')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001936895824'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 't2zonerequest')
...
URL = "https://master-416k.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://master-416k.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://master-416k.onrender.com/".format(FQDN)
else:
    URL = "https://master-416k.onrender.com/".format(FQDN)
